      ...
      <div className="max-w-screen-lg w-full flex gap-3 pb-24 justify-around">
        <div className="flex flex-col text-white border-[3px] bg-[#0F262E] border-[#20459E] rounded-[25px] w-[410px] p-7">
          <h3 className="flex justify-between items-center mb-7">
            <img src={favicon} alt="farm_eth" className="w-20" />
            <p className="font-bold text-2xl">
              DRIP INU <span className="text-[#28CDC4]">(ICY)</span>
            </p>
          </h3>
          ...
          <div className="flex justify-between mt-2">
            ...
            <button className="py-3 px-10 font-bold text-sm rounded-[24px] bg-[#363433] w-40">
              COMPOUND
            </button>
          </div>
          <p className="font-bold">
            ICY <span className="text-[#28CDC4]">STAKED</span>
          </p>
